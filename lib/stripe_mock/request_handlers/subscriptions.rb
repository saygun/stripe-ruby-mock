    ...
    module Subscriptions
      ...
      def create_subscription(route, method_url, params, headers)
        ...
        invoice = Data.mock_invoice([
          Data.mock_line_item({
            ...
            amount: subscription_plans.first[:amount],
            subscription: subscription[:id],
            plan: subscription_plans.first[:id]
          })
        ], {
          id: new_id('in'),
          customer: params[:customer]
      ...
      def subscription_payment_intent(invoice)
        new_payment_intent(
          ...
          nil,
          {
            payment_method: customers.first[1][invoice[:customer]][:invoice_settings][:default_payment_method],
